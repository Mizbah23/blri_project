...
class CreateProductReceiveDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_receive_details', function (Blueprint $table) {
           ...
           $table->bigIncrements('id');
            ...
            $table->unsignedBigInteger('product_receive_id');
            ...
            $table->foreign('product_receive_id')->references('id')->on('product_receives');
