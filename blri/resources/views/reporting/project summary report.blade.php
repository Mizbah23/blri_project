                ...
                <form class="form-horizontal" method="post"> <div class="form-group"> 
                  @csrf
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="col-md-5">
                          <label for="" class="col-sm-5 control-label">প্রকল্প</label>
                        </div>
                        <div class="col-md-7">
                        ...
                        <div class="col-md-5">
                          <label for="" class="col-sm-5 control-label">কর্মচারী</label>
                        </div>
                        <div class="col-md-7">
                          <select id="" name="" class="form-control required" required>
                                 <option value=""> নির্বাচন করুন</option>
                      ...
                      <div class="col-md-6">
                        ...
                        <div>
                          <label>
                                 ...
                                 প্রকল্পের ভিত্তিতে পণ্য প্রতিবেদন
                             </label>
                        </div><br>
                        ...
                        <div>
                          <label>
                                 ...
                                 কর্মচারী ভিত্তিতে পণ্য প্রতিবেদন
                             </label>
                        </div><br>

                        <div>
                          <label>
                                 <input type="radio" name="purchasereport" id="" value="5" ng-checked="true" ng-click="()"/>
                               পণ্য মেরামতের রিপোর্ট
                             </label>
                        </div><br>
