...
<html>
<head>
<title>মেরামত পণ্য প্রাপ্তির তথ্য</title>
        ...
        <div class=" form-grids row form-grids-right">
            <div class="widget-shadow " data-example-id="basic-forms"> 
              <div class="form-title bg-primary text-white">
                <h3 class="">মেরামতকৃত পণ্য প্রাপ্তির তথ্য</h3>
              </div>
              <div class="form-body">
                ...
                <div id="allBrands">
                  <table id="example" class="table table-responsive table-hover table-striped table-bordered table-condensed">
                     ...
                     <tbody>
                       @foreach ($receives as $key=>$item)
                         <tr class="row">
                            <td>{{$item->serialInfo->productInfo->productName}}</td>
                            <td>{{$item->repairer->repairerName}}</td>
                            <td>{{date('d/m/Y', strtotime(str_replace('-', '/',$item->receiveDate))) }}</td>
                            <td>{{$item->comments}}</td>
                            <td class="text-center"><a href="{{route('product distribution.repairReceiveEdit',[$item->id])}}"><i class="fa fa-edit" style="color:blue;font-size: 24px"></i></a></td>
                          </tr>
                           @endforeach
                     </tbody>
                  </table>
