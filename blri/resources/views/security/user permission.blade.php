...
<html>
<head>
<title>ব্যবহারকারীর অনুমতি</title>
...
$( function() {
  ...
  <!-- select all script starts-->

<!-- select all script ends-->
                  ...
                  <table class="table table-responsive table-hover table-striped table-bordered table-condensed">
                      <tr class="row bg-primary">
                        ...
                        <th class="col-lg-8 text-center">প্রধান সূচি</th>
                                ...
                                <tr class="row">
                                    <td class="text-center"><input type='checkbox' name='check' id='check_1'></td>
                                    <td>a</td>
                                  
                                </tr>
                                <tr class="row">
                                    <td class="text-center"><input type='checkbox' name='check' id='check_2'></td>
                                    <td>b</td>
                                  
                                </tr>
                                <tr class="row">
                                    <td class="text-center"><input type='checkbox' name='check' id='check_3'></td>
                                    <td>c</td>
