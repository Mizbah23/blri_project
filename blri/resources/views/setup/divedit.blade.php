...
<body class="cbp-spmenu-push">
                 ...
                 <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6"> <!--Category and brand-->
                       ...
                       <div class="col-lg-9">
                          <input type="text" class="form-control" id="departmentName" name="departmentName"value="{{$department->DepartmentName}}"placeholder="Name Can not be empty"required>
  ...
  <script>
    function cancelUpdate() {
      document.location.href="{!! route('setup.division'); !!}";
    }
  </script>
