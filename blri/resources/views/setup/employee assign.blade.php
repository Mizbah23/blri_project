                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-5">
                          ...
                          <button type="button" onclick="resetAll()" class="btn btn-danger">বাতিল করুন</button>
                          </div>
                  ...
                  <table id="example" class="table table-responsive table-hover table-striped table-bordered table-condensed">
                     ...
                     <tbody>
                      ...
                      <tr class="row">
                        ...
                        <td class="text-center"><a href="{{route('setup.employee assign.edit',$assignEmployee->id)}}"><i class="fa fa-edit" style="font-size:24px"></i></a></td>
                      </tr>
                      @endforeach
                     </tbody>
                  </table>
